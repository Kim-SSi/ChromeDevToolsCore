...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Debugger
{
	...
	public class SetBreakpointByUrlCommand: ICommand<SetBreakpointByUrlCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets Regex pattern for the URLs of the resources to set breakpoints on. Either `url` or`urlRegex` must be specified.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets Expression to use as a breakpoint condition. When specified, debugger will only stop on thebreakpoint if this expression evaluates to true.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
