...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class GetPropertiesCommand: ICommand<GetPropertiesCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets If true, returns properties belonging only to the element itself, not to its prototypechain.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public bool? OwnProperties { get; set; }
		/// <summary>
		/// Gets or sets If true, returns accessor properties (with getter/setter) only; internal properties are notreturned either.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
