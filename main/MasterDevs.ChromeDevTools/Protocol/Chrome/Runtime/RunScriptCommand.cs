...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class RunScriptCommand: ICommand<RunScriptCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets Specifies in which execution context to perform script run. If the parameter is omitted theevaluation will be performed in the context of the inspected page.
		/// </summary>
