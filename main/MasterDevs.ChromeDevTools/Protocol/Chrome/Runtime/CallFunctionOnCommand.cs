...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Runtime
{
	...
	public class CallFunctionOnCommand: ICommand<CallFunctionOnCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets Identifier of the object to call function on. Either objectId or executionContextId shouldbe specified.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public string ObjectId { get; set; }
		/// <summary>
		/// Gets or sets Call arguments. All call arguments must belong to the same JavaScript world as the targetobject.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		...
		/// <summary>
		/// Gets or sets Specifies execution context which global object will be used to call function on. EitherexecutionContextId or objectId should be specified.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
		public long? ExecutionContextId { get; set; }
		/// <summary>
		/// Gets or sets Symbolic group name that can be used to release multiple objects. If objectGroup is notspecified and objectId is, objectGroup will be inherited from object.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
